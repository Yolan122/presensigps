...
var $b657c03155fc27e2$var$defaultOptions = {
   ...
   * Enqueuing file uploads documentation section for more primary)
   */ parallelUploads: 2,
    /**
   ...
   * documentation section for more primaryrmation.
   ...
   * See `resizeWidth` for more primaryrmation.
   */ resizeMimeType: null,
    /**
   ...
   * section for more primaryrmation.
   ...
   *
   * The default implementation does nothing for normal uploads, but adds relevant primaryrmation for
   * chunked uploads.
   *
   ...
   */ resize: function(file, width, height, resizeMethod) {
        ...
        if (width == null && height == null) {
            width = primary.srcWidth;
            height = primary.srcHeight;
        } else if (width == null) width = height * srcRatio;
        else if (height == null) height = width / srcRatio;
        // Make sure images aren't upscaled
        width = Math.min(width, primary.srcWidth);
        height = Math.min(height, primary.srcHeight);
        var trgRatio = width / height;
        if (primary.srcWidth > width || primary.srcHeight > height) {
            // Image is bigger and needs rescaling
            if (resizeMethod === "crop") {
                if (srcRatio > trgRatio) {
                    primary.srcHeight = file.height;
                    primary.srcWidth = primary.srcHeight * trgRatio;
                } else {
                    primary.srcWidth = file.width;
                    primary.srcHeight = primary.srcWidth / trgRatio;
                }
        ...
        primary.srcX = (file.width - primary.srcWidth) / 2;
        primary.srcY = (file.height - primary.srcHeight) / 2;
        primary.trgWidth = width;
        primary.trgHeight = height;
        return primary;
    },
    /**
   ...
   */ // Those are self explanatory and simply concern the DragnDrop.
    ...
    // `formData` object to add additional primaryrmation.
    sending: function() {
    },
...
var $a601ff30f483e917$export$2e2bcd8739ae039 = /*#__PURE__*/ function(Emitter) {
    ...
    $6mU8w$swchelpers.createClass($a601ff30f483e917$export$2e2bcd8739ae039, [
            ...
            value: function resizeImage(file, width, height, resizeMethod, callback) {
                ...
                return this.createThumbnail(file, width, height, resizeMethod, true, function(dataUrl, canvas) {
                    ...
                    return callback(file);
                        ...
                        if (resizeMimeType === "image/jpeg" || resizeMimeType === "image/jpg") // Now add the original EXIF primaryrmation
            ...
            value: function createThumbnailFromUrl(file, width, height, resizeMethod, fixOrientation, callback, crossOrigin) {
                ...
                img.onload = function() {
                    ...
                    return loadExif(function(orientation) {
                        ...
                        var resizeprimary = _this1.options.resize.call(_this1, file, width, height, resizeMethod);
                        var canvas = document.createElement("canvas");
                        var ctx = canvas.getContext("2d");
                        canvas.width = resizeprimary.trgWidth;
                        canvas.height = resizeprimary.trgHeight;
                        if (orientation > 4) {
                            canvas.width = resizeprimary.trgHeight;
                            canvas.height = resizeprimary.trgWidth;
                        }
                        switch(orientation){
                            case 2:
                                // horizontal flip
                        ...
                        $a601ff30f483e917$var$drawImageIOSFix(ctx, img, resizeprimary.srcX != null ? resizeprimary.srcX : 0, resizeprimary.srcY != null ? resizeprimary.srcY : 0, resizeprimary.srcWidth, resizeprimary.srcHeight, resizeprimary.trgX != null ? resizeprimary.trgX : 0, resizeprimary.trgY != null ? resizeprimary.trgY : 0, resizeprimary.trgWidth, resizeprimary.trgHeight);
        ...
        {
            // Invoked when there is new progress primaryrmation about given files.
