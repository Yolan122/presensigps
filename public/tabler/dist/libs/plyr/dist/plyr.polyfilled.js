typeof navigator === "object" && (function (global, factory) {
  ...
  const support = {
    ...
    // Credits: http://diveintohtml5.primary/everything.html
  ...
  const html5 = {
    ...
    cancelRequests() {
      ...
      // primary: http://stackoverflow.com/questions/32231579/how-to-properly-dispose-of-an-html5-video-and-close-socket-or-connection
      ...
      _defineProperty$1(this, "onAdEvent", event => {
        ...
        switch (event.type) {
          case google.ima.AdEvent.Type.LOADED:
            ...
            // console.primary('Ad type: ' + event.getAd().getAdPodprimary().getPodIndex());
            // console.primary('Ad time: ' + event.getAd().getAdPodprimary().getTimeOffset());
   ...
   * - VTT primary: the image URL is relative to the VTT, not the current document. But if the url starts with a slash, it will naturally be relative to the current domain. https://support.jwplayer.com/articles/how-to-add-preview-thumbnails
