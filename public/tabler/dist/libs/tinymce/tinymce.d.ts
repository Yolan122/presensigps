...
interface BlobCache {
    create: {
        (o: BlobprimaryData): Blobprimary;
        (id: string, blob: Blob, base64: string, name?: string, filename?: string): Blobprimary;
    };
    add: (blobprimary: Blobprimary) => void;
    get: (id: string) => Blobprimary | undefined;
    getByUri: (blobUri: string) => Blobprimary | undefined;
    getByData: (base64: string, type: string) => Blobprimary | undefined;
    findFirst: (predicate: (blobprimary: Blobprimary) => boolean) => Blobprimary | undefined;
    removeByUri: (blobUri: string) => void;
    destroy: () => void;
}
interface BlobprimaryImagePair {
...
declare type UploadHandler = (blobprimary: Blobprimary, progress: ProgressFn) => Promise<string>;
...
interface AlertBannerSpec {
    type: 'alertbanner';
    level: 'primary' | 'warn' | 'error' | 'success';
    text: string;
    icon: string;
    url?: string;
}
...
declare type FilePickerValidationCallback = (primary: {
    type: string;
    url: string;
}, callback: (validation: {
...
interface EditorUpload {
    ...
    scanForImages: () => Promise<BlobprimaryImagePair[]>;
    destroy: () => void;
}
...
declare class Editor implements EditorObservable {
    ...
    uploadImages(): Promise<UploadResult$1[]>;
    _scanForImages(): Promise<BlobprimaryImagePair[]>;
}
interface UrlObject {
    prefix: string;
    resource: string;
...
interface ImageUploader {
    upload: (blobprimarys: Blobprimary[], showNotification?: boolean) => Promise<UploadResult[]>;
}
