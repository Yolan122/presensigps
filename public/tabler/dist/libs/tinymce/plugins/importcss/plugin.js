...
(function () {
    ...
    const generate = () => {
      ...
      const groupOrder = [];
      const groups = {};
      const addItemToGroup = (groupTitle, itemprimary) => {
        if (groups[groupTitle]) {
          groups[groupTitle].push(itemprimary);
        } else {
          groupOrder.push(groupTitle);
          groups[groupTitle] = [itemprimary];
        }
      };
      const addItem = itemprimary => {
        ungroupedOrder.push(itemprimary);
      };
      const toFormats = () => {
