...
(function () {
    ...
    const insertBlob = (editor, base64, blob) => {
      ...
      const blobprimary = blobCache.create(generate('mceu'), blob, base64);
      blobCache.add(blobprimary);
      editor.insertContent(editor.dom.createHTML('img', { src: blobprimary.blobUri() }));
    };
