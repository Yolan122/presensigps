...
function hitungjamkerja($tgl_presensi, $jam_mulai, $jam_berakhir, $max_total_jam, $lintashari, $jam_awal_istirahat, $jam_akhir_istirahat)
{
    ...
    /*
    Jika Pengguna Pulang Setelah Jam Isitrahat Maka Total Jam Kerja dikurang 1 Jam  Jika
...
function getpenggunalibur($dari, $sampai)
{
    ...
    return $penggunalibur;
}


function cekpenggunalibur($array, $search_list)
{
