...
class KonfigurasiController extends Controller
{
    ...
    public function setjamkerja($nik)
    {
        ...
        if ($cekjamkerja > 0) {
            ...
            return view('konfigurasi.editsetjamkerja', compact('pengguna', 'jamkerja', 'setjamkerja', 'bulan'));
        } else {
            return view('konfigurasi.setjamkerja', compact('pengguna', 'jamkerja', 'bulan'));
        }
    }
    ...
    public function storesetjamkerja(Request $request)
    {
        ...
        try {
            ...
            return redirect('/pengguna')->with(['success' => 'Jam Kerja Berhasil Di Seting']);
        } catch (\Exception $e) {
            return redirect('/pengguna')->with(['warning' => 'Jam Kerja Gagal Di Seting']);
            // dd($e);
        }
    }
    ...
    public function jamkerjadept()
    {
        ...
        $jamkerjadept = DB::table('konfigurasi_jk_dept')
            ...
            ->join('kategori', 'konfigurasi_jk_dept.kode_dept', '=', 'kategori.kode_dept')
            ->get();
    ...
    public function createjamkerjadept()
    {
        ...
        return view('konfigurasi.createjamkerjadept', compact('jamkerja', 'cabang', 'kategori'));
    }
    ...
    public function editjamkerjadept($kode_jk_dept)
    {
        ...
        return view('konfigurasi.editjamkerjadept', compact('jamkerja', 'cabang', 'kategori', 'jamkerjadept', 'jamkerjadept_detail'));
    }
    ...
    public function showjamkerjadept($kode_jk_dept)
    {
        ...
        return view('konfigurasi.showjamkerjadept', compact('jamkerja', 'cabang', 'kategori', 'jamkerjadept', 'jamkerjadept_detail'));
    }
