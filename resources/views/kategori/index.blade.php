...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="#" class="btn btn-secondary" id="btnTambahKategori">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <form action="/kategori/{{ $d->kode_dept }}/delete"
    ...
    <div class="modal modal-blur fade" id="modal-inputkategori" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/kategori/store" method="POST" id="frmKategori">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" id="nama_dept" value="" class="form-control"
                                        name="nama_dept" placeholder="Nama Kategori">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(function() {
            $("#btnTambahKategori").click(function() {
                $("#modal-inputkategori").modal("show");
            });
