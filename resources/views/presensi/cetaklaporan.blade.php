...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        ...
        <table class="tabeldatapengguna">
            <tr>
                <td rowspan="6">
                    @php
                        $path = Storage::url('uploads/pengguna/' . $pengguna->foto);
                    @endphp
        ...
        <table width="100%" style="margin-top:100px">
            <tr>
                <td colspan="2" style="text-align: right">Muara Panas, {{ date('d-m-Y') }}</td>
            </tr>
            <tr>
                <td style="text-align: center; vertical-align:bottom" height="100px">
                    <u>Mike Origiana</u><br>
                    <i><b>Wakil Kurikulum</b></i>
                </td>
