...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @role('administrator', 'user')
                                <div class="row">
                                    <div class="col-12">
                                        <a href="#" class="btn btn-secondary" id="btnTambahpengguna">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ($pengguna as $d)
                                                @php
                                                    $path = Storage::url('uploads/pengguna/' . $d->foto);
                                                @endphp
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if ($d->status_location == 1)
                                                            <a href="/pengguna/{{ $d->nik }}/lockandunlocklocation">
                                                    ...
                                                    <td class="text-center">
                                                        @if ($d->status_jam_kerja == 1)
                                                            <a href="/pengguna/{{ $d->nik }}/lockandunlockjamkerja">
                                                                <span class=" badge bg-danger badge-sm">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        class="icon icon-tabler icon-tabler-lock"
                                                                        width="24" height="24" viewBox="0 0 24 24"
                                                        ...
                                                        <div class="d-flex">
                                                            <div>
                                                                ...
                                                                <a href="/konfigurasi/{{ $d->nik }}/setjamkerja"
                                                                    class="btn btn-secondarys btn-sm ml-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                ...
                                                                <a href="/pengguna/{{ Crypt::encrypt($d->nik) }}/resetpassword"
                                                            ...
                                                            @role('administrator', 'user')
                                                                <div>
                                                                    <form action="/pengguna/{{ $d->nik }}/delete"
    ...
    <div class="modal modal-blur fade" id="modal-inputpengguna" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/pengguna/store" method="POST" id="frmPengguna" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
    ...
    {{-- Modal Edit --}}
    <div class="modal modal-blur fade" id="modal-editpengguna" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
        $(function() {
            ...
            $("#btnTambahpengguna").click(function() {
                $("#modal-inputpengguna").modal("show");
            });
            ...
            $("#frmPengguna").submit(function() {
                var nik = $("#nik").val();
                var nama_lengkap = $("#nama_lengkap").val();
                var jabatan = $("#jabatan").val();
                var no_hp = $("#no_hp").val();
                var kode_dept = $("#frmPengguna").find("#kode_dept").val();
                var kode_cabang = $("#frmPengguna").find("#kode_cabang").val();
                if (nik == "") {
                    ...
                    Swal.fire({
                        title: 'Warning!',
                        text: 'Kategori Jabatan Harus Diisi !',
                        icon: 'warning',
                        confirmButtonText: 'Ok'
                    }).then((result) => {
                        $("#kode_dept").focus();
