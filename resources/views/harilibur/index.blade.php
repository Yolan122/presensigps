                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @role('administrator', 'user')
                                <div class="row">
                                    <div class="col-12">
                                        <a href="#" class="btn btn-secondary" id="btntambahHarilibur">
                                                        ...
                                                        <div class="d-flex">
                                                            @role('administrator', 'user')
                                                                <div>
                                                                    ...
                                                                    <a href="#" class="edit btn btn-primary btn-sm mr-1"
                                                                    ...
                                                                    <a href="/konfigurasi/harilibur/{{ $d->kode_libur }}/setpenggunalibur"
                                                                        class="btn btn-secondarys btn-sm">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
