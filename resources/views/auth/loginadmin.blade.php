...
<head>
    ...
    <style>
        ...
        body {
            background: linear-gradient(to bottom, #f0f0f0, #7686ce); /* Gradasi abu-abu terang ke biru */
                ...
                <div class="col-lg">
                    <div class="container-tight">
                        ...
                        <div class="card card-md">
                            <div class="card-body">
                                <h2 class="h2 text-center mb-4">Login Dashboard Tim Digital</h2>
                                <p class="text-center">SMAN 1 BUKIT SUNDI</p>
                                ...
                                <form action="/prosesloginadmin" method="post" autocomplete="off" novalidate>
                                    ...
                                    <div class="mb-2">
                                        <label class="form-check">
                                            ...
                                            <span class="form-check-label">Ingat Login</span>
                                        </label>
                                    </div>
