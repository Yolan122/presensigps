<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
                <img src="{{ asset('tabler/static/LOGO.PNG') }}" width="110" height="32" alt="E-PRESENSI"
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is(['pengguna', 'kategori', 'cabang']) ? 'show' : '' }}"
                        href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="{{ request()->is(['pengguna', 'kategori', 'cabang']) ? 'true' : '' }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <div
                        class="dropdown-menu {{ request()->is(['pengguna', 'kategori', 'cabang', 'cuti']) ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                @role('administrator|admin kategori', 'user')
                                    <a class="dropdown-item {{ request()->is(['pengguna']) ? 'active' : '' }}"
                                        href="/pengguna">
                                        Data Pengguna
                                    </a>
                                @endrole
